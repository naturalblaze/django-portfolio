...
from portfolio_blog.models import Portfolio, Project, ResumeJobs, ResumeSkills, ResumeEducation, ResumeCertifications
...
class HomeView(ListView):
    ...
    template_name = "portfolio_blog/index.html"
    paginate_by = 5
    ...
    def get_template_names(self):
        ...
        if self.request.htmx:
            return ["portfolio_blog/project-list-elements.html"]
...
class ResumeView(ListView):
    ...
    template_name = "portfolio_blog/resume.html"
...
class ProjectsView(ListView):
    ...
    model = Project
    context_object_name = "projects"
    template_name = "portfolio_blog/project-all.html"
    paginate_by = 5
    ...
    def get_template_names(self):
        """Get template names based on request type."""
        if self.request.htmx:
            return "portfolio_blog/project-all-partial.html"
...
class ProjectView(DetailView):
    ...
    template_name = "portfolio_blog/project-single.html"
...
class AboutView(DetailView):
    ...
    template_name = "portfolio_blog/about.html"
