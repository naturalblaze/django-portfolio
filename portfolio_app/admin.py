"""Admin configuration for portfolio_app app."""

from typing import List
from django.contrib import admin
from portfolio_app.models import Portfolio, Project, ResumeSkills, ResumeEducation, ResumeJobs, ResumeCertifications
